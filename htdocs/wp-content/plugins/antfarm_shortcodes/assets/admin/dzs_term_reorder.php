    ...
    class Dzs_Term_Reorder{
        ...
        function print_parent_terms(){
            ...
            if($tax){
                ...
                ?>"><a class="active" href="edit.php?<?php echo $tax_init; ?>=<?php echo "all"; ?>&post_type=<?php echo $post_type_init; ?>&zoom-term-reorder=on"><?php echo esc_html__("All"); ?></a></li>
        ...
        function term_reorder(){
            ...
            if(isset($_GET['zoom-term-reorder']) && $_GET['zoom-term-reorder']=='on' ){
                ...
                $tax = $antfarm->name_port_item_cat;
                ...
                <div class="dzs-sort-portfolio" data-meta-key="<?php echo $meta_key; ?>">
                    <table class="wp-list-table wp-list-meta-sort widefat fixed striped posts">
                        ...
                        <tr>
                            ...
                            <th scope="col"  class="manage-column column-order"><?php echo esc_html__("Priority"); ?></th>
                            <th scope="col" id="author" class="manage-column column-author"><?php echo esc_html__("Author"); ?></th>

                            <th scope="col" id="date" class="manage-column column-date sortable asc">
                                <span><?php echo esc_html__("Date"); ?></span>
                            </th>
                        ...
                        foreach ($posts as $po){
                            ...
                            ?><tr id="<?php echo $po->ID; ?>" class="iedit author-self level-0 post-<?php echo $po->ID; ?> type-antfarm_port_items status-publish has-post-thumbnail hentry antfarm_port_items_cat-gallery-masonry meta-order-tr <?php
                            ...
                            ?>" data-colname="Title">
                                ...
                                <div class="row-actions"><span class="edit"><a href="<?php echo admin_url('post.php?post='.$po->ID.'&amp;action=edit'); ?>" aria-label="Edit “<?php echo $po->post_title; ?>”">Edit</a> </span></div><button type="button" class="toggle-row"><span class="screen-reader-text">Show more details</span></button></td>
                            ...
                            <td class="author column-order post-term-order " data-colname="Order">
                                ...
                                $meta_order_lab = count($posts) - $meta_order + 1 ;

                                echo $meta_order_lab;

                                ?>
                            </td>
                            <td class="author column-author" data-colname="Author"><a href="edit.php?post_type=antfarm_port_items&amp;author=1">admin</a></td>
                        ...
                        <tr>
                            ...
                            <th scope="col" class="manage-column column-title column-primary sortable desc"> <?php echo esc_html__("Title"); ?> </th>
                            <th scope="col" class="manage-column column-order"><?php echo esc_html__("Priority"); ?></th>
                            <th scope="col" class="manage-column column-author"><?php echo esc_html__("Author"); ?></th>
                            <th scope="col" class="manage-column column-date sortable asc"><a href="http://localhost:8888/wordpress/wp-admin/edit.php?antfarm_port_items_cat=gallery-masonry&amp;post_type=antfarm_port_items&amp;zoom-reorder=on&amp;orderby=date&amp;order=desc"><span>Date</span><span class="sorting-indicator"></span></a></th>
                        </tr>
                        </tfoot>
            ...
            foreach ($arr as $po){
                ...
                if($aux['thumb']){
                    ...
                    if(get_post_meta($po,'dzsvp_thumb',true)){
                        ...
                        if(get_post_meta($po,'dzstln_featured_media',true)){
                            $aux['thumb'] = get_post_meta($po,'dzstln_featured_media',true);
                        }
                    }
                }
