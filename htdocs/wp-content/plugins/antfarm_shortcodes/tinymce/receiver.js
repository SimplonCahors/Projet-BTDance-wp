function dzstln_receiver(arg){
    ...
    //console.log(jQuery('#dzstlnb-pagebuilder-con'), jQuery('#dzstlnb-pagebuilder-con').css);
    if(jQuery('#dzstlnb-pagebuilder-con').length > 0 && jQuery('#dzstlnb-pagebuilder-con').eq(0).css('display')=='block' && typeof top.dzstlnb_lastfocused!='undefined'){
        jQuery(top.dzstlnb_lastfocused).val(arg);
        jQuery(top.dzstlnb_lastfocused).trigger('change');
    }else{
