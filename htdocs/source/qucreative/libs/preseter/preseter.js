...
jQuery(document).ready(function($){
    ...
    function preseter_init(){
        ...
        // console.info("preseter - ",_preseter);
        ...
        $('.select-wrapper select').bind('change', change_select);


        if(window.dzsscr_init){

            var _cmc = $('.main-container').eq(0);
            $(document).on('mouseover','.preseter-content-con',function(){


                _cmc.data('bubble-scroll','on');



            })
            $(document).on('mouseout','.preseter-content-con',function(){


                _cmc.data('bubble-scroll','off');
    ...
    $('.the-content-inner-con').addClass('native-scroll');
