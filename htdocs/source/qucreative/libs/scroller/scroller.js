    ...
    $.fn.scroller = function(o) {
        ...
        this.each(function() {
            ...
            function init() {
                ...
                // console.warn("LETS INIT SCROLLBAR", 'is_touch_device()', is_touch_device(), cthis );
...
//                    console.info('hmm');
                ...
                if(o.type=='scrollTop'){
                    ...
                    $(document).delegate('a[href^="#"]','click', function(){
                        ...
                        var _t23 = $(this);
                        if($(_t23.attr('href')).length>0 && !( _t23.attr('data-vc-container') ) ){
                ...
                if(_inner && _inner.get(0) && (_inner.get(0).style.height=='' || _inner.get(0).style.height=='auto')){
                    _inner_autoheight = true;
                }

                if(o.settings_autoheight=='auto'){
                    if(cthis.get(0)&&cthis.get(0).style.height=='' || cthis.get(0).style.height=='auto'){
            ...
            function calculateDims() {
                ...
                if(o.type=='scrollTop'){
                    ...
                    if(Math.abs(comHeight-last_comHeight)>99){
                        ...
                        // console.info("difference BIG", comHeight, wh, viewIndexY);;
                        if(comHeight<last_comHeight){
                            //scrollIndexY = viewIndexY / (comHeight - totalHeight) * -(totalHeight - scrollbary_psize);
                            // console.info("call scroll from resize body ? or comHeight", comHeight, wh, viewIndexY);;
                            if(comHeight< wh){
                                viewIndexY=0;
                                scrollIndexY=0;
                            }else{
...
//                console.info(dir_hor, dir_ver);
                ...
                if (o.settings_scrollbar == 'on') {
                    ...
                    // console.log('scrollbar -> ',_scrollbar);
...
//                percomWidth = comWidth + 50;
            ...
            if (o.settings_scrollbyhover != 'on' && ( cthis.hasClass('is-touch')==false || o.settings_disableSpecialIosFeatures == 'on')){
                ...
                // console.info('scroll type - ',o.type, cthis);
                if(o.type=='scrollTop'){
                    ...
                    // cthis.onmousewheel = handle_wheel;
                    // cthis.on('mousewheel',handle_wheel);
                    // cthis.find('.scroller').on('mousewheel.dzs3',handle_wheel);

                    // console.info("ADDING NORMAL WHEEL EVENTS", cthis);
                }
            ...
            function handle_wheel(e){
                ...
                // console.info(cthis, cthis.data('bubble-scroll'));

                if(cthis.data('bubble-scroll')!='on'){
                    if(o.type=='normal'){

                        // console.info('handle_wheel()', e, e.deltaY, cthis);
                    }
                    if(o.type=='scrollTop'){
...
//                console.log(cthis.has($(e.target)).length);
            ...
            if ((cthis.hasClass('is-touch')==false) || o.settings_disableSpecialIosFeatures == 'on') {
                $(document).mousemove(function(e) {
                    ...
                    if(o.type=='normal'){
                        // console.info(mousex, totalWidth);
                    }

                    // console.info('o.settings_show_sidebar_on_right_side_mouse - ',o.settings_show_sidebar_on_right_side_mouse, cthis);
                    if(o.settings_show_sidebar_on_right_side_mouse=='on'){
                        // console.info(mousex, mousey, cthis.offset().left, cthis.width(), cthis);

                        if( ( mousex>cthis.offset().left + cthis.width()-100 && mousex<=cthis.offset().left + cthis.width() && mousey>cthis.offset().top && mousey<=cthis.offset().top + cthis.height() )  || (o.type=='normal' && mousex > totalWidth - 100 )){
