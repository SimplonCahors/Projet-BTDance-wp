            ...
            function check_if_items_can_show(pargs){
                ...
                if(swnext){
                    ...
                    for(var i in images_tobeloaded){
                        ...
                        if(images_tobeloaded[i].loaded == "on"){
            ...
            function excerpt_content_resize_vplayer(){
                ...
                if(_excerptContent && _excerptContent.find('.vplayer').length>0){
                    ...
                    if(_c.data('initial-height-for-excerpt-content')){
                        ...
                        auxih = 0.562 * _excerptContent.width();
                        if(_c.parent().hasClass('dzs-col-8')){

                            auxih = 0.562 * _c.parent().width();
                        }
    ...
    proto.layoutPosition = function() {
        ...
        if(xvalue.indexOf('%')>-1){
            ...
            if(_c.hasClass('zfolio')){
                if(_c.hasClass('temp-dzs-layout--5-cols')){
                    perc_amount = 20;
                }
                if(_c.hasClass('temp-dzs-layout--4-cols')){
                    perc_amount = 25;
                }
                if(_c.hasClass('temp-dzs-layout--3-cols')){
                    perc_amount = 33.333;
                }
