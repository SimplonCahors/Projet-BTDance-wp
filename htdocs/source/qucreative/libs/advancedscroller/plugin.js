...
(function($) {
    ...
    $.fn.advancedscroller = function(o) {
        var defaults = {
            ...
            ,settings_lazyLoading_load_otheritems_after_loading_first_items: 'off'
        ...
        this.each(function() {
            ...
            function init(){
                ...
                if(cthis.hasClass('skin-qucreative')){
                    o.settings_skin = 'skin-qucreative';
                    if(o.design_arrowsize=='default'){
                        o.design_arrowsize = 0;
                    }
                    if(o.design_bulletspos=='default'){
                ...
                _arrowsCon.append('<div class="arrow-left bg-color-hg-on-hover"></div>');
                _arrowsCon.append('<div class="arrow-right bg-color-hg-on-hover"></div>');
...
//                    console.info(_thumbsClip);
                ...
                setTimeout(function(){
                    ...
                    // console.warn('o.settings_lazyLoading_load_otheritems_after_loading_first_items -> ',o.settings_lazyLoading_load_otheritems_after_loading_first_items);
                    if(o.settings_lazyLoading_load_otheritems_after_loading_first_items=='on'){
            ...
            function checkWhenLoaded(){
                ...
                // console.info('checkWhenLoaded');
                cthis.find('.item.needs-loading:not(.image-is-loaded)').each(function(){
                    var _t = $(this);
...
//                    console.info(toload);
                    ...
                    if(typeof(toload)=="undefined"){
                        ...
                        args.target = toload;
                        args.called_from = 'line 559 nothing toload';
                        ...
                        args.called_from = 'line 574 hastoload';
            ...
            function loadedImage(pargs){
                ...
                if(margs.target){
                    ...
                    if(_t.hasClass('imagediv')){
                        // console.info("IS IMAGEDIV, realimg is -> ",margs.target.realimg);
                    }
                ...
                // console.warn('loadedImage', margs, '_t -> ',_t);
                ...
                if(_t.hasClass('imagediv')){
                    ...
                    _t.attr('data-natural_w',_t.get(0).realimg.naturalWidth);
                    _t.attr('data-natural_h',_t.get(0).realimg.naturalHeight);
                }
                loadedArray[ind]=1;
                ...
                if(_con){
                    ...
                    if(_img.naturalWidth){
                        ...
                        _con.addClass('image-is-loaded');
                        _con.attr('data-naturalWidth' , _img.naturalWidth);
                    }
                    if(_img.naturalHeight){
                        _con.data('naturalHeight' , _img.naturalHeight);
                        _con.attr('data-naturalHeight' , _img.naturalHeight);
                    }
            ...
            function calculate_dims(pargs){
                ...
                if(o.design_itemwidth=='25%'){
                    items_per_page = 4;
                }
                if(o.design_itemwidth=='20%'){
                    items_per_page = 5;
                }
                if(o.design_itemwidth=='16.66%'){
                    items_per_page = 6;
                }
                ...
                _thumbsClip.children().each(function(){
                    ...
                    var _t = $(this);
                    // console.info("item - ", _t);

                    _t.find('.height-same-as-item-width').height(_t.width());
                })

                // console.warn(o.settings_mode, cthis);
                if(o.settings_mode=='onlyoneitem'){
                    items_per_page=1;
                ...
                if(String(design_itemwidth).indexOf("%")>-1){
                    ...
                    _thumbsClip.children().css('width', parseFloat(String(design_itemwidth))/100 * (_thumbsClip.width()) );
                }
                ...
                for(i=0;i<pag_total_thumbnr;i++){
                    ...
                    if(!cthis.hasClass('islastpage') || pag_excess_thumbnr==0){
                        ...
                        if(cthis.attr('class').indexOf('item-padding-')==-1){
            ...
            function calculate_dims_hard(){
                ...
                // console.info('sw_ctw - ',sw_ctw);
                // console.info('sw_tw - ',sw_tw, _thumbsCon);
            }
...
//                console.log(_t, sw_tw, sw_ctw);
                ...
                $(document).bind('mousemove', function(e){
                    if(dragging==false){
                        ...
                        // console.info('screen_mousex - ', screen_mousex);
                        // console.info(currPageX, def_x, screen_mousex, down_x);
                        // console.log(-sw_ctw,sw_tw);

                        if(cthis.hasClass('transition-slide')) {
...
//                        console.log(sw_tw, sw_ctw);
                ...
                _swiper.bind('touchmove', function(e){
                    ...
                    if(dragging){
                        ...
                        if(cthis.hasClass('transition-slide')){
                            ...
                            // console.warn('currPageX - ',currPageX);
                            // console.info('def_x - ',def_x);
                            // console.info('up_x - ',up_x);
                            // console.info('down_x - ',down_x);
                            // console.info('sw_ctw,sw_tw - ',sw_ctw,sw_tw,-sw_ctw+sw_tw);
                            // console.error('targetPositionX - ',targetPositionX);
                            if(targetPositionX>0){
                                targetPositionX/=2;
                            }
                ...
                function checkswipe(){
                    ...
                    // console.info(up_x, down_x, sw_tw);
                    ...
                    if(sw==false){
                        if(cthis.hasClass('transition-slide')) {
                            ...
                            //_swiper.animate({left: currPageX},{
                            //    queue:false
                            //    ,duration: 300
                            //});
                            //console.info("HMM");
            ...
            function loadItem(arg){
                ...
                // console.info('loadItem', arg, lazyLoadingArray[arg],lazyLoadingArray);
...
//                        _t.append('<div class="imagediv" style="background-image:url('+_t.attr('data-source')+')"></div>');
            ...
            function gotoPage(arg,pargs){
                ...
                if(currPage > -1 && currPage!=arg && o.settings_mode=='onlyoneitem'){
                    ...
                    if(o.settings_transition=='wipeoutandfade'){
                        ...
                        // console.info('gotoPage', 'fadeoutCurrPage', currPage, _c);
                        ...
                        if(_c.children('.wipeout-wrapper').length==0){
                            ...
                            if(_c.children('img').length>0){
                                ...
                                if(_c.find('.imagediv').length>0){

                                    _c.find('.imagediv').wrap('<div class="wipeout-wrapper"><div class="wipeout-wrapper-inner"></div></div>');
                                }else{
                                    if(_c.find('.vplayer').length>0){
                            ...
                            // console.info('_c.outerWidth() -> ',_c.outerWidth());

                            _c.find('.wipeout-wrapper-inner').eq(0).outerWidth(_c.outerWidth());
                        ...
                        _c.children('.wipeout-wrapper').animate({
                            ...
                            ,complete:function(){
                                setTimeout(function(arg){
                                    ...
                                    _c.find('.wipeout-wrapper-inner').css('width' ,'');
                ...
                if(o.settings_wait_for_do_transition_call!='on'){
                    ...
                    if(o.settings_transition=='wipeoutandfade'){
                        ...
                        setTimeout(function(){
                            ...
                            _thumbsClip.children().removeClass("currItem-visible");
                        },animation_time);

                        //console.info('do transition from hier');
                        setTimeout(do_transition,animation_time+200);
                        // setTimeout(do_transition,animation_time);
                    }
                }else{

                    // console.warn('waiting for call do_transition from outside :P');
                }
            ...
            function do_transition(pargs){
                ...
                // console.warn('do_transition has arrived',margs);
                // console.log(margs);
                ...
                if(o.settings_mode=='onlyoneitem'){
                    ...
                    if(o.settings_transition=='fade'||o.settings_transition=='wipeoutandfade'||o.settings_transition=='flyout'||o.settings_transition=='slide'){
                        ...
                        _c.find('.caption').each(function(){
                            var _cp = $(this);


                            if(_cp.hasClass('skin-blurred')){
                                //console.info(_cp, _cp.get(0).style.left);
                                ...
                                var offset_css_left = '';
                                var offset_css_top = '';
                                if(_cp.get(0).style.left){
                                    auxcp = parseInt(_cp.get(0).style.left,10);
                                    offset_css_left = -auxcp;
                                }
                                //console.info('_cp.get(0).style.top - ',_cp.get(0).style.top, '_cp.get(0).style.marginRight - ',_cp.get(0).style.marginRight,_c.find('.imagediv').eq(0),_c.find('.imagediv').eq(0).height());
                                if(_cp.get(0).style.top){

                                    auxcp = parseInt(_cp.get(0).style.top,10);
                                    offset_css_top = - auxcp;
                                }


                                //console.info('_cp.get(0).style.right - ',_cp.get(0).style.right);
                                if(_cp.get(0).style.right){

                                    auxcp = parseInt(_cp.get(0).style.right,10);
                                    offset_css_left = - (tw - auxcp - _cp.outerWidth());
                                }
                                if(_cp.get(0).style.bottom){

                                    auxcp = parseInt(_cp.get(0).style.bottom,10);
                                    offset_css_top = - (th - auxcp - _cp.outerHeight());
                                }

                                if(_cp.find('.blur-bg').eq(0).children().length==0){

                                    _cp.find('.blur-bg').append(_c.find('.imagediv').eq(0).clone());

                                }
                                if(_cp.parent().hasClass('center-it-v')){

                                    offset_css_top =  - (th*0.5 - _cp.outerHeight()/2);
                                    if(_cp.parent().hasClass('align-right')){

                                        offset_css_left = - (tw - 0 - _cp.outerWidth());
                                    }
                                    if(_cp.parent().hasClass('align-center')){

                                        offset_css_left = - (tw * 0.5 - _cp.outerWidth() * 0.5);
                                    }
                                }

                                _cp.find('.blur-bg > .imagediv').css({
                                    'width':realcw
                                    ,'height':_c.find('.imagediv').eq(0).height()
                                    ,'left':offset_css_left
                                    ,'top':offset_css_top
                                });
                                //console.info(offset_css_left,offset_css_top,realch);
                            }
                    ...
                    if(o.settings_transition=='wipeoutandfade'){
                        ...
                        if(!cthis.hasClass('no-need-for-nav')){
                            ...
                            var auxw = parseInt(_thumbsClip.children().eq(0).outerWidth(true),10);
                            if(margs.force_width && margs.force_width>0){

                                auxw = (margs.force_width);

                                auxw = parseInt(margs.force_width,10);

                                //console.info('auxw',auxw,pag_total_pagenr);
                                _thumbsClip.width(auxw* pag_total_pagenr + 40);


                                // console.info('auxw -',auxw);
                    ...
                    if(o.settings_autoHeight=='on'){
                        ...
                        if(margs.force_width && margs.force_width>0){
                            ...
                            // console.log('margs.force_width 2256 -> ',margs.force_width);
                            _thumbsCon.width(margs.force_width);
                            _thumbsCon.addClass('width-already-set');
                        }
